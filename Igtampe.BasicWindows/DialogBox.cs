...
namespace Igtampe.BasicWindows {
    ...
    public class DialogBox {
        ...
        public static int MaxWidth => Console.WindowWidth - 5;

        /// <summary>Maximum height of dialogboxes</summary>
        public static int MaxHeight => Console.WindowHeight - 3;
        ...
        public DialogBoxResult Execute() {
            ...
            return OKButton?.Flag == true ? DialogBoxResult.OK
              : CancelButton?.Flag == true ? DialogBoxResult.Cancel
              : YesButton?.Flag == true ? DialogBoxResult.Yes
              : NoButton?.Flag == true ? DialogBoxResult.No
              : AbortButton?.Flag == true ? DialogBoxResult.Abort
              : RetryButton?.Flag == true ? DialogBoxResult.Retry
              : IgnoreButton?.Flag == true ? DialogBoxResult.Ignore
              : DialogBoxResult.Nothing;
        ...
        /// <param name="Text"></param>
        /// <returns>Returns a DialogBoxResult based on whichever button was pressed.</returns>
        public static DialogBoxResult ShowDialogBox(Icon.IconType Type, DialogBoxButtons Buttons, string Text) => new DialogBox(Type, Buttons, Text).Execute();

        /// <summary>Shows an error dialog box by using the data in the provided exception.</summary>
        /// <param name="E"></param>
        /// <returns></returns>
        public static DialogBoxResult ShowExceptionError(Exception E) => new DialogBox(Icon.IconType.ERROR, DialogBoxButtons.OK, "An unhandled exception has occurred: " + E.Message + "\n\n" + StrippedStackTrace(E)).Execute();
