...
namespace Igtampe.BasicWindows {
    ...
    public class GuruMeditationErrorScreen {
        ...
        public static void Show(Exception E, bool Stripped) => new GuruMeditationErrorScreen(E, Stripped).Render();
    }
}
